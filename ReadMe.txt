...
This project implements a tokenization system using Solidity, allowing for the creation and management of a custom ERC-20 token (ART) with additional features for auctions related payments. 
